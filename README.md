...
module ariful::profile {
    ...
    struct Engineer has key {
        ...
        also:    vector<String>,   // [b"Sui", b"Walrus", b"Seal", b"EVM"]
        contact: String,           // linkedin.com/in/marifulislam099
    }
}
```

### Networks
`Aptos` &nbsp; `Shelby` &nbsp; `Sui` &nbsp; `EVM`

### Languages
`Move` &nbsp; `Rust` &nbsp; `TypeScript` &nbsp; `Solidity` &nbsp; `C / C++` &nbsp; `Python` &nbsp; `SQL`
